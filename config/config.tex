...
% Frontespizio
%**************************************************************
\newcommand{\myName}{Davide Polonio, Emanuele Carraro}          % autori
\newcommand{\myTitle}{Bioinformatics 1}
\newcommand{\myUni}{Universit√† degli Studi di Padova}          % universit√
\newcommand{\myFaculty}{Corso di Laurea in Informatica}         % facolt√
